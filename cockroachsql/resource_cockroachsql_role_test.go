		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("cockroachsql_role.role_with_defaults", "valid_until", "infinity"),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("cockroachsql_role.update_role", "login", "true"),
					resource.TestCheckResourceAttr("cockroachsql_role.update_role", "valid_until", "infinity"),
