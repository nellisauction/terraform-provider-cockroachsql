...
func TestCreateGrantQuery(t *testing.T) {
	...
	cases := []struct {
		...
		{
			resource: schema.TestResourceDataRaw(t, resourceCockroachSQLGrant().Schema, map[string]any{
				"object_type": "table",
				"schema":      databaseName,
				"role":        roleName,
			}),
...
func TestAccCockroachSQLGrant(t *testing.T) {
	skipIfNotAcc(t)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"cockroachsql_grant.test", "id", fmt.Sprintf("%s_%s_test_schema_table", roleName, dbName),
					),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.#", "1"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.0", "SELECT"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.#", "3"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.0", "INSERT"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.1", "SELECT"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.2", "UPDATE"),
					func(*terraform.State) error {
			...
			// We test to revoke everything
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.#", "0"),
					func(*terraform.State) error {
...
func TestAccCockroachSQLGrantColumns(t *testing.T) {
	skipIfNotAcc(t)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "objects.#", "1"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "objects.0", "test_table"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "columns.#", "2"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.#", "1"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.0", "SELECT"),
					func(*terraform.State) error {
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "objects.0", "test_table"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "columns.#", "2"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "columns.0", "test_column_one"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.#", "1"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.0", "INSERT"),
					func(*terraform.State) error {
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "columns.0", "test_column_one"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.#", "1"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.0", "UPDATE"),
...
func TestAccCockroachSQLGrantObjects(t *testing.T) {
	skipIfNotAcc(t)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"cockroachsql_grant.test", "id", fmt.Sprintf("%s_%s_test_schema_table_test_table", roleName, dbName),
					),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "objects.#", "1"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "objects.0", "test_table"),
					func(*terraform.State) error {
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "objects.#", "2"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "objects.0", "test_table"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "objects.1", "test_table2"),
					func(*terraform.State) error {
						return testCheckTablesPrivileges(t, dbName, roleName, testTables, []string{"SELECT"})
					},
				),
			...
			},
			{
				...
				Config: fmt.Sprintf(testGrant, `[]`),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "objects.#", "0"),
					func(*terraform.State) error {
						return testCheckTablesPrivileges(t, dbName, roleName, testTables, []string{"SELECT"})
					},
				),
...
func TestAccCockroachSQLGrantObjectsError(t *testing.T) {
	skipIfNotAcc(t)
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `resource "cockroachsql_grant" "test" {
					database    = "test_db"
					role        = "test_role"
					object_type = "database"
					objects     = ["o1", "o2"]
...
func TestAccCockroachSQLGrantColumnsError(t *testing.T) {
	skipIfNotAcc(t)
...
func TestAccCockroachSQLGrantPublic(t *testing.T) {
	skipIfNotAcc(t)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"cockroachsql_grant.test", "id", fmt.Sprintf("public_%s_test_schema_table", dbName),
					),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.#", "1"),
					func(*terraform.State) error {
...
func TestAccCockroachSQLGrantEmptyPrivileges(t *testing.T) {
	skipIfNotAcc(t)
				...
				Steps: []resource.TestStep{
					{
						Config: tfConfig,
						Check: resource.ComposeTestCheckFunc(
							resource.TestCheckResourceAttr("cockroachsql_grant.test", "id", fmt.Sprintf("%s_defaultdb_test_schema_function", role)),
							resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.#", "1"),
				...
				Steps: []resource.TestStep{
					{
						Config: tfConfig,
						Check: resource.ComposeTestCheckFunc(
							resource.TestCheckResourceAttr("cockroachsql_grant.test", "id", fmt.Sprintf("%s_defaultdb_test_schema_function_test(text, char)", role)),
							resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.#", "1"),
							resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.0", "EXECUTE"),
							resource.TestCheckResourceAttr("cockroachsql_grant.test", "with_grant_option", "false"),
				...
				Steps: []resource.TestStep{
					{
						Config: tfConfig,
						Check: resource.ComposeTestCheckFunc(
							resource.TestCheckResourceAttr("cockroachsql_grant.test", "id", fmt.Sprintf("%s_defaultdb_test_schema_procedure", role)),
							resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.#", "1"),
							resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.0", "EXECUTE"),
							resource.TestCheckResourceAttr("cockroachsql_grant.test", "with_grant_option", "false"),
				...
				Steps: []resource.TestStep{
					{
						...
						Check: resource.ComposeTestCheckFunc(
							resource.TestCheckResourceAttr("cockroachsql_grant.test", "id", fmt.Sprintf("%s_defaultdb_test_schema_routine", role)),
							resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.#", "1"),
							resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.0", "EXECUTE"),
							resource.TestCheckResourceAttr("cockroachsql_grant.test", "with_grant_option", "false"),
...
resource "cockroachsql_database" "test_db" {
	depends_on = [cockroachsql_role.test]
	name = "test_grant_db"
}
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Not allowed to create
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "id", "test_grant_role_test_grant_db_database"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.#", "1"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "with_grant_option", "false"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "id", "test_grant_role_defaultdb_test_schema_schema"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.#", "1"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "with_grant_option", "false"),
...
func TestAccCockroachSQLGrantForeignDataWrapper(t *testing.T) {
	skipIfNotAcc(t)
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Grant usage
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "id", "test_role_defaultdb_foreign_data_wrapper_test_fdw"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.#", "1"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "with_grant_option", "true"),
...
func TestAccCockroachSQLGrantForeignServer(t *testing.T) {
	skipIfNotAcc(t)
	skipIfNotSuperuser(t)
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Grant usage
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "id", "test_role_defaultdb_foreign_server_test_srv"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "privileges.#", "1"),
					resource.TestCheckResourceAttr("cockroachsql_grant.test", "with_grant_option", "false"),
...
func TestAccCockroachSQLGrantOwnerPG15(t *testing.T) {
	skipIfNotAcc(t)
...
func testCheckFunctionExecutable(t *testing.T, role, function string) func(*terraform.State) error {
	return func(*terraform.State) error {
		db := connectAsTestRole(t, role, "defaultdb")
		defer closeDB(t, db)
...
func testCheckSchemaPrivileges(t *testing.T, usage, create bool) func(*terraform.State) error {
	return func(*terraform.State) error {
		...
		db := connectAsTestRole(t, "test_grant_role", "defaultdb")
		defer closeDB(t, db)
...
func testCheckForeignDataWrapperPrivileges(t *testing.T, usage bool) func(*terraform.State) error {
	return func(*terraform.State) error {
		...
		db := connectAsTestRole(t, "test_role", "defaultdb")
		defer closeDB(t, db)
